...
\frametitle{Planar Circular Restricted Three-Body Problem}
	...
	\note[itemize]{
		\item Nondimensionlize via characteristic time, length, mass
		\item Assumptions to allow for tractability of problem
		\item Circular orbits of primaries about system barycenter
		\item Spacecraft has small mass compared to primaries and its motion has no effect on primaries. 
		Can decouple the problem
		\item Planar problem assumption
	}
\end{frame}   %-----------------------------%
...
\end{columns}
	...
	\note[itemize]{
		\item Rotating reference frame allows for structure to become visible
	}
\end{frame}   %-----------------------------%
...
\begin{column}{0.5\textwidth}
 ...
 \end{columns}
 	...
 	\note[itemize]{
 		\item Jacobi integral defines realms of possible motion
 	}
\end{frame}   %-----------------------------%
